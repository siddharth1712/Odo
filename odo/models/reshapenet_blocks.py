...
from odo.models.reshapenet_transformer import Transformer2DModel
    ...
    def forward(
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states,curr_reference_feat_idx = attn(
                    hidden_states,
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, output_states,curr_reference_feat_idx
