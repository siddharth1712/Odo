...
from odo.models.referencenet_blocks import (
    UNetMidBlock2D,
...
class UNet2DConditionOutput(BaseOutput):
    """
    The output of [`ReferenceNetUNet`].
...
class ReferenceNetUNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
    ...
    def forward(
        ...
        r"""
        The [`ReferenceNetUNet`] forward method.
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples,out_reference_feat = downsample_block(
                ...
                reference_features += out_reference_feat
            else:
        ...
        if self.mid_block is not None:
            if hasattr(self.mid_block, "has_cross_attention") and self.mid_block.has_cross_attention:
                sample,out_reference_feat = self.mid_block(
                    sample,
                    emb,
                    encoder_hidden_states=encoder_hidden_states,
                    attention_mask=attention_mask,
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample,out_reference_feat = upsample_block(
                    hidden_states=sample,
                    temb=emb,
