...
import nlf.pytorch.backbones.efficientnet as effnet_pt
import nlf.pytorch.models.metrabs as metrabs_pt
from nlf.pytorch import multiperson_model
...
def load_multiperson_model():
    ...
    with torch.device('cuda'):
        return multiperson_model.MultipersonNLF(
