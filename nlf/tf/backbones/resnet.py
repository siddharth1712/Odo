...
def ResNet(
    ...
    # Load weights.
    if weights == 'imagenet' and model_name in WEIGHTS_HASHES and not FLAGS.batch_renorm:
        if include_top:
    ...
    elif weights is not None and weights != 'imagenet':
...
def ResNetUnified(
    ...
    use_group_norm = False #FLAGS.group_norm
